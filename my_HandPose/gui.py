...
def drawInferences(values, names=['', '', '', '', '', '', '', '', '']):
    ...
    blank = np.zeros((550,700,3), np.uint8)
...
def test():
    values = [0.2, 0.3, 0.1, 0.9, 0.6, 0.21, 0.4, 0.17, 0.23]
    names = ['Cursor', 'Enter', 'Esc', 'LeftClick', 'WheelClick', 'RightClick', 'ScrollUp', 'ScrollDown', 'Spacebar']
    while(True):
